<template>
  <div id="main">
    ...
    <tabs :Menutabs="Menutabs" operate="true" father="apply_cancle" :queryState="queryState" @getTab="getTab"></tabs>
        ...
        created:function(){
           ...
           methods:{
            ...
            getList(val,type1,type2,type3,code,name){
             ...
             this.$axios.get(this.$baseURL+'/slb-order-applications-records?code='+code+'&customerName='+name+'&page='+(val-1)+'&pageSize=10&size=10&sort=createTime,desc&type=1&states='+that.tabName+'&isCancel=false&type1='+type1+'&type2='+type2+'&type3='+type3,{
                   headers:{
